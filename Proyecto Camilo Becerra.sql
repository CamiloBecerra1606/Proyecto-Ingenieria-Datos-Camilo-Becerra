...
COPY Persona (PERSONA_ID, PERIODO, TIPO_DNI, COD_DANE, FECHA_NACIMIENTO, EDAD, GRUPO_ETARIO, VINCULACION, GENERO, ESTRATO, SNIES, LUGAR, TIPO, LONGITUD, LATITUD, POB_VULNERABLE)
